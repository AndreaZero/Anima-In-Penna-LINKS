    ...
    <div className="App">
      ...
      <div className='App-title'>
        ...
        <div className="App-cd">
                  <iframe title="Spotify" src="https://open.spotify.com/embed/album/3lCjNn502IOMkbVwnUAwnJ?utm_source=generator" width="550px" height="200px" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe><br></br>
                  </div>
        <div className='yt-title'>
            <h3>👇 HABEMUS TANICA - IL VIDEO UFFICIALE 👇</h3>
          </div>
          <div className="yt-video">
          <iframe width="800" height="400" src="https://www.youtube.com/embed/uzJS_tMFtfs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
        <div className="App-link-container">
          ...
          <div className='instapost'>
            <a href="https://www.instagram.com/p/CikSfAgoWHQ/"><img src={post} alt="post"></img></a>
          </div>
          <br></br>
